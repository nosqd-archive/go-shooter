...
func (self *Packet) ReadVector2() rl.Vector2 {
	return rl.Vector2{
		X: self.ReadFloat32(),
		Y: self.ReadFloat32(),
	}
}
func (self *Packet) WriteVector2(value rl.Vector2) rl.Vector2 {
	self.WriteFloat32(value.X)
	self.WriteFloat32(value.Y)
	return value
}
func (self *Packet) ReadVector3() rl.Vector3 {
	return rl.Vector3{
		X: self.ReadFloat32(),
		Y: self.ReadFloat32(),
		Z: self.ReadFloat32(),
...
func (self *Packet) WriteVector3(value rl.Vector3) rl.Vector3 {
	self.WriteFloat32(value.X)
	self.WriteFloat32(value.Y)
	self.WriteFloat32(value.Z)
	return value
}
func (self *Packet) ReadVector4() rl.Vector4 {
	return rl.Vector4{
		X: self.ReadFloat32(),
		Y: self.ReadFloat32(),
		Z: self.ReadFloat32(),
...
func (self *Packet) WriteVector4(value rl.Vector4) rl.Vector4 {
	self.WriteFloat32(value.X)
	self.WriteFloat32(value.Y)
	self.WriteFloat32(value.Z)
	self.WriteFloat32(value.W)
	return value
}
